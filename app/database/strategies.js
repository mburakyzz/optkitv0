const strategies = [
    ...
    { id: 6, name: 'longPut', img: require('../assets/longPut.png'), options: [{ id: 1, mony: [1,2,3,4,5], type: 'P', pos: 'L' }] },
    { id: 7, name: 'shortCall', img: require('../assets/shortCall.png'), options: [{ id: 1, mony: [1,2,3,4,5], type: 'C', pos: 'S' }] },
    { id: 8, name: 'bearCallSpread', img: require('../assets/bearCallSpread.png'), options: [{ id: 1, mony: [1, 2], type: 'P', pos: 'L' }, { id: 2, mony: [4, 5], type: 'C', pos: 'L' }] },
